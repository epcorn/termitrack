...
// Accepts props named exactly as passed from your Home.jsx:
// - selectedFeature: The Set of currently selected feature names from Home's state
// - onFeatureToggle: The function to call when a feature is clicked (this is 'hangleToggleFeature' from Home)
// - Features: The object mapping keys to feature name strings { termite: "Termite...", moister: "Moister..." } from Home
export default function GetInTouch({ selectedFeature, onFeatureToggle, Features }) {
  ...
  // Get the feature name strings (e.g., "Termite Tracker", "Moister Sensor")
  // by extracting the *values* from the Features object prop passed from Home.
  // Provide a default empty object to prevent errors if Features prop is somehow missing.
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              {featuresToDisplay.map((featureName) => (
                <div
                  ...
                  className={`col-span-1 p-3 rounded-md cursor-pointer transition-all ease-in-out border-2 font-medium ${ // duration-200
