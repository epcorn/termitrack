...
import  ITRAKER_PRODUCT from '../images/ITRAKER_PRODUCT.png'; // Assuming default image path
    ...
    <section className="py-16 lg:py-24 bg-white">
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12 lg:gap-16">
          ...
          <div className="md:w-4/12 flex justify-center p-1 border-2 border-yellow-400 rounded-lg"> {/* Added p-1, border-2, border-yellow-400, rounded-lg */}
            <img
              src={imageUrl}
              alt={imageAlt}
          ...
          <div className="md:w-7/12 text-gray-700">
            ...
            {paragraphs.map((text, index) => (
              <p key={index} className="mb-5 text-base md:text-lg leading-relaxed">
                {text}
              </p>
            ))}
