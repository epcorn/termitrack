...
const BenefitCard = ({ icon, title, description }) => (
  <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-lime-500 h-full"> {/* Added h-full */}
     <div className="flex items-start mb-3"> {/* Adjusted alignment */}
        <div className="mr-3 mt-1 text-green-600 text-2xl flex-shrink-0"> {/* Added flex-shrink-0 */}
